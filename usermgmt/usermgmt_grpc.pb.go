...
type UserManagementClient interface {
	CreateNewUser(ctx context.Context, in *NewUserRequest, opts ...grpc.CallOption) (*UserResponse, error)
	GetUsers(ctx context.Context, in *GetUsersParamsRequest, opts ...grpc.CallOption) (*UserListResponse, error)
}
...
func (c *userManagementClient) CreateNewUser(ctx context.Context, in *NewUserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (c *userManagementClient) GetUsers(ctx context.Context, in *GetUsersParamsRequest, opts ...grpc.CallOption) (*UserListResponse, error) {
...
type UserManagementServer interface {
	CreateNewUser(context.Context, *NewUserRequest) (*UserResponse, error)
	GetUsers(context.Context, *GetUsersParamsRequest) (*UserListResponse, error)
...
func (UnimplementedUserManagementServer) CreateNewUser(context.Context, *NewUserRequest) (*UserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateNewUser not implemented")
}
func (UnimplementedUserManagementServer) GetUsers(context.Context, *GetUsersParamsRequest) (*UserListResponse, error) {
...
func _UserManagement_CreateNewUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserManagementServer).CreateNewUser(ctx, req.(*NewUserRequest))
	}
...
func _UserManagement_GetUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserManagementServer).GetUsers(ctx, req.(*GetUsersParamsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
